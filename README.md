...
- [The rationale to map the business requirements to the Data Visualizations and ML tasks 🗺️](#the-rationale-to-map-the-business-requirements-to-the-data-visualizations-and-ml-tasks-️)
  - [Business Requirement 1: Understand factors influencing bulldozer auction prices](#business-requirement-1-understand-factors-influencing-bulldozer-auction-prices)
  - [Business Requirement 2: Accurate price prediction system using historical data](#business-requirement-2-accurate-price-prediction-system-using-historical-data)
